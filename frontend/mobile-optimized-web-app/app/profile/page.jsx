  ...
  const handleEditSave = async (e) => {
    ...
    try {
      ...
      const mapToSnake = (obj) => ({
        ...
        phone_number: obj.phone || obj.phoneNumber,
        address: obj.address,
        ...
        {loading ? (
          ...
          <div className="w-full max-w-md mx-auto bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 flex flex-col items-center relative">
            ...
            <div className="w-full grid grid-cols-1 gap-3 text-base text-gray-700 mb-6">
              ...
              <InfoRow label="Phone" value={profile.phone || profile.phoneNumber || 'N/A'} />
                ...
                >
                  ...
                  >
                    <div className="flex flex-col gap-6">
                      ...
                      <EditInputMinimal label="Phone" name="phone" value={editData.phone || ''} onChange={handleEditChange} />
...
function EditInputMinimal({ label, name, value, onChange, type = "text" }) {
  return (
